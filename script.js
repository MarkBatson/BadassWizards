...
scenario = new Scenario(
  ...
  ,"You sneak up to his sleigh and take some presents. You nab some good gifts but feel bad for ruining some kid’s Christmas. <i>Obtain item 8 but lose 2 points</i>"
  ...
  ,"You bribe the reindeer and hijack Santa’s sleigh, flying into the winter night. This year, it’s you that brings joy to children all around the world. <i>Earn 4 points and item 8</i>"
);
scenarios.push(scenario);
...
scenario = new Scenario(
  ...
  ,"The old man hands you a sword. You have no idea where he thinks you’re going, seeing as you’re both currently trapped in a cell, but it’s the thought that counts. <i>Obtain item 9</i>"
  ,"You scoff at the old man and roll into the corner, executing a perfect frame jump roll infinite sword glitch that teleports you to the final boss in an instant. <i>Earn 4 points and item 9</i>"
);
scenarios.push(scenario);
...
scenario = new Scenario(
  ...
  ,"Using your wizard powers you obtain a special promotional sauce from another dimension and add it to your dish. The sauce is so good that the chef becomes utterly lost in it, melting into a puddle before your very eyes. You keep his knife as a souvenir. <i>Earn 4 points and take an item number 11</i>"
);
scenarios.push(scenario);
...
scenario = new Scenario(
  ...
  ,"Not only did you get the best deal on a new TV, but you’ve been saving a rare coupon that makes the deal so good, they’re actually paying you to take the TV. You have successfully exploited capitalism. <i>Earn 4 points and item number 12</i>"
);
scenarios.push(scenario);
...
scenario = new Scenario(
  ...
  ,"You refuse to play such a childish game and instead work out a trade. You give him your expendable left kidney in exchange for a small magical item. <i>Lose 2 points and gain item 15</i>"
  ,"The man thinks you chose rock, but you were just balling up a fist so you could punch him in the face as hard as you can. You knock him out and steal all of his stuff. <i>Gain item 15</i>"
  ,"When you notice the man is trying to cheat, you grab his knife and cuts off all his fingers. Now, he can only choose paper. Your perfect information strategy guarantees your win. <i>Gain 4 points and item 15</i>"
);
scenarios.push(scenario);
...
scenario = new Scenario(
  ...
  ,"You never miss a cup and win the game with a shot off the wall and your eyes closed. You are hailed as the greatest beer pong player of all time. <i>Earn 4 points and item number 16</i>"
);
scenarios.push(scenario);
...
scenario = new Scenario(
  ...
  ,"As the shark jumps on the island to try and eat you, you suddenly remember that one movie and frantically shove an air tank into its mouth, making the shark temporarily retreat. As it pulls around for another attack, you pull out a gun and take aim. Just before the shark reaches you, you fire at the tank, and the shark explodes into gruesome chunks. <i>Earn 5 points</i>"
  ,"You jump on the shark. It tries to hurl you off, but you hold on with all your might. Finally, the shark submits to your will. You are now a wizard riding a shark. <i>Earn 5 points and item 20</i>"
);
scenarios.push(scenario);
...
function outcome(threshold) {
  ...
  if(threshold.value == "bust") {
    ...
    if (number == 69) {
      document.getElementById("outcome").innerHTML = "You dirty boy."
    }
